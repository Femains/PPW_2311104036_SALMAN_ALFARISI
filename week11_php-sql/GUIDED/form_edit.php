<?php
// File: form_edit.php
// Fungsi: Menampilkan form edit data mahasiswa

include "koneksi.php";

// Ambil NIM dari URL (aman)
    ...
    <form method="POST" action="proses_edit.php">
        ...
        <div class="form-group">
            ...
            <select name="jurusan" required>
                ...
                <option value="Teknologi Informasi" <?php if ($data['jurusan'] == 'Teknologi Informasi') echo 'selected'; ?>>
                    Teknologi Informasi
                </option>
                <option value="Ilmu Komputer" <?php if ($data['jurusan'] == 'Ilmu Komputer') echo 'selected'; ?>>
                    Ilmu Komputer
                </option>
            </select>
        </div>
