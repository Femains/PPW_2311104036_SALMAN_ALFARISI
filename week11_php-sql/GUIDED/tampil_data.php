...
// Fungsi: Menampilkan semua data mahasiswa + fitur pencarian
...
<body>
    ...
    if (isset($_GET['keyword']) && $_GET['keyword'] != '') {
        ...
        echo "<p class='info-text'>
                Ditemukan <strong>$jumlah</strong> data dengan keyword:
                <span class='keyword-highlight'>'" . htmlspecialchars($keyword) . "'</span>
              </p>";
    } else {
        ...
        echo "<p class='info-text'>
                Menampilkan <strong>$jumlah</strong> data mahasiswa
              </p>";
    }
    ?>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            <a href='form_edit.php?nim=" . urlencode($row['nim']) . "' class='btn btn-edit'>Edit</a>
                ...
                if (isset($_GET['keyword']) && $_GET['keyword'] != '') {
                    echo "<tr>
                            <td colspan='7' style='text-align:center; color:red;'>
                                Data tidak ditemukan dengan keyword tersebut!
                            </td>
                          </tr>";
                } else {
                    echo "<tr>
